...
/**
 * Created by quikr on 17/2/16.
 */
public class MEscrowElectronicEndToEndTests extends MEscrowTestBase {
    ...
    public void MAOFromVap() {
        ...
        postAdElectronicWOMinPrice(testData,sellerEmail,sellerMobilenum);
    ...
    public void MAOWithMinPrice() {
        ...
        homePage.closeLanguagePopUp();
        homePage.clickPostAdButtonHomePage();
        postAdElectronicWithMinPrice(testData,sellerEmail,sellerMobilenum);
        Assert.assertTrue(papPage.ifAdPostSuccess(), "Ad was not posted");
        AdId = papPage.getAdId();
        apiBase.publishAd(AdId);
        papPage.navigateHome();
    ...
    public void MAOFromVapWarehouse() {
        ...
        homePage.closeLanguagePopUp();
        homePage.clickPostAdButtonHomePage();
        postAdWarehouseElectronic(testData,sellerEmail,sellerMobilenum);
        Assert.assertTrue(papPage.ifAdPostSuccess(), "Ad was not posted");
        AdId = papPage.getAdId();
    ...
    public void SameListingAndReservedPrice() {
        ...
        homePage.closeLanguagePopUp();
        homePage.clickPostAdButtonHomePage();
        postAdElectronicWithSameMinPrice(testData,sellerEmail,sellerMobilenum);
        Assert.assertTrue(papPage.ifAdPostSuccess(), "Ad was not posted");
        AdId = papPage.getAdId();
        apiBase.publishAd(AdId);
        papPage.navigateHome();
